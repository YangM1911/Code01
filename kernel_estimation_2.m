function [new_ker1,new_ker2,new_ker3] = kernel_estimation_2(y_1,y_2,y_3,h_org_HD_1, gammaL_pixel, gammaL_grad, opts,threshold,threshold_all,skeleton_method);
...
new_ker1 = denoised_k1 * sum(sum(h_org_HD_1));
...
new_ker2 = denoised_k2 * sum(sum(h_org_HD_1));
...
new_ker3 = denoised_k3 * sum(sum(h_org_HD_1));
